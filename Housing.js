...
// TODO: Sign up for a token for year filtering	+ '&$where=reported?' + '2015-01-01'
		...
		info.update = function (props) {
			this._div.innerHTML = '<h4 style="margin: auto; background-color: white;">Open Housing Violations in Hartford</h4><br/>Sourced from <a href="https://data.hartford.gov/"> Hartford Open Data </a>
			<br/>Code available on <a href='https://github.com/jtcond13/HartfordHousing/'>Github.</a>';
		};
